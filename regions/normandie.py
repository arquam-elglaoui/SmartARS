...
def extraire_normandie(mois_num, annee):
    ...
    for mois_nom in get_mois_variantes(mois_num):
        url = f"{BASE_URL}/normandie/Documents-publications/Recueil-des-Actes-Administratifs/Recueil-des-Actes-Administratifs-{annee}/Recueils-des-actes-administratifs-regionaux-{mois_nom.capitalize()}-{annee}"
