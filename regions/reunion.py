...
def extraire_reunion(mois_num, annee):
    ...
    mois_nom = MOIS_NOMS.get(mois_num, "").upper()
    url = f"{BASE_URL}/Publications/Publications-administratives-et-legales/Recueil-des-actes-administratifs-RAA/Recueil-des-actes-administratifs-{annee}/{mois_nom}"
