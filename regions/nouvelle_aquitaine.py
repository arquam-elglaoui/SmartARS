...
def extraire_nouvelle_aquitaine(mois_num, annee):
    ...
    url = f"{BASE_URL}/nouvelle-aquitaine/Documents-publications/Recueil-des-Actes-Administratifs/Recueil-des-Actes-Administratifs-pour-l-annee-{annee}/{mois_nom}-{annee}/"
